            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="view/admin/pages/tables.php"><i class="fa fa-table fa-fw"></i> Tables</a>
                        </li>
                        <li>
                            <a href="view/admin/pages/forms.php"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        </li>
                        <li>
